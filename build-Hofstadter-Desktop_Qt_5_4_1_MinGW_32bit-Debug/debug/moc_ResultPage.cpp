...
struct qt_meta_stringdata_ResultPage_t {
    QByteArrayData data[5];
    char stringdata[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ResultPage_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ResultPage_t qt_meta_stringdata_ResultPage = {
    {
QT_MOC_LITERAL(0, 0, 10), // "ResultPage"
QT_MOC_LITERAL(1, 11, 12), // "showSequence"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1), // "r"
QT_MOC_LITERAL(4, 27, 1) // "c"

    },
    "ResultPage\0showSequence\0\0r\0c"
};
...
const QMetaObject ResultPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_ResultPage.data,
      qt_meta_data_ResultPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ResultPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ResultPage.stringdata))
