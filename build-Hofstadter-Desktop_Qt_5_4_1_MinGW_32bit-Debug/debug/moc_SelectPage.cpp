...
struct qt_meta_stringdata_SelectPage_t {
    QByteArrayData data[7];
    char stringdata[79];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SelectPage_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SelectPage_t qt_meta_stringdata_SelectPage = {
    {
QT_MOC_LITERAL(0, 0, 10), // "SelectPage"
QT_MOC_LITERAL(1, 11, 13), // "saveRecursion"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 15), // "removeRecursion"
QT_MOC_LITERAL(4, 42, 14), // "updateLineEdit"
QT_MOC_LITERAL(5, 57, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(6, 74, 4) // "item"

    },
    "SelectPage\0saveRecursion\0\0removeRecursion\0"
    "updateLineEdit\0QListWidgetItem*\0item"
};
...
const QMetaObject SelectPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_SelectPage.data,
      qt_meta_data_SelectPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SelectPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelectPage.stringdata))
